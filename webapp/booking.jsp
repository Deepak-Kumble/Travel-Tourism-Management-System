                ...
                String database_password = "Zvhxjen3NCOotNN7Srnf";
        		   try {
        	            ...
        	            Connection con = DriverManager.getConnection(
        	                ...
        	                ResultSet rs;
        	                rs = stmt2.executeQuery("select TP_id,bus_name,Pfrom,Pto,Arrival_time,Departure_time,Fare,Seat,Bdate from BusSchedule,place,TBooking where BusSchedule.place_id = place.place_id and TPayment.bid = BusSchedule.bus_id and TPayment.Cid ="+cid );
